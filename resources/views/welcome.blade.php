...
<div class="main-banner header-text" id="top">
    <div class="Modern-Slider">
        ...
        <div class="item">
            <div class="img-fill">
                <img src="{{asset('images/pugbanner1.jpg') }}" alt="">
                <div class="text-content">
                    <h3>Bienvenido a la veterinaria y estetica para animales</h3>
                    <h5 style="font-weight: bold;">"El CACHORRITO"</h5>
        ...
        <div class="item">
            <div class="img-fill">
                <img src="{{asset('images/husky-slide.jpg') }}" alt="">
                <div class="text-content">
                    <h3>Bienvenido a la veterinaria y estetica para animales</h3>
                    <h5 style="font-weight: bold;">"El CACHORRITO"</h5>
        ...
        <div class="item">
            <div class="img-fill">
                <img src="{{asset ('images/gato-slide.jpg') }}" alt="">
                <div class="text-content">
